...
\begin{frame}[plain]{Extra time = (a) playing Call of Duty or (b) search for better jobs?}
...
\item {\small{} China Shock from the presentation that we have seen in class a few weeks ago is one example. \medskip{}
}{\small \par}
