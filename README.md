...
1. **Human Capital**
	...
	2. *Returns to schooling empirics*
...
2. **Self-Selection**
	1. *Roy and Generalized Roy models*
	...
	2. *Selection model econometrics*
		...
		- Heckman, James, and Edward Vytlacil (2007). "Econometric Evaluation of Social Programs, Part II." *Handbook of Econometrics* Volume 6B.
	...
	3. *Self-selection applications*
		...
		- Cornelissen, Thomas, Christian Dustmann, Anna Raute, and Uta Schonberg (forthcoming). "Who Benefits From Universal Child Care? Estimating Marginal Returns to Early Child Care Attendance." *Journal of Political Economy*.
...
3. **Labor Demand + Wage Inequality**
	...
	- Heckman, J., & Scheinkman, J. (1987). "The importance of bundling in a Gorman-Lancaster model of earnings." *Review of Economic Studies*, 54(2), 243-255.
	- Jäger, S. (2016). "How substitutable are workers? Evidence from worker deaths."
	...
	- Berman, E., Bound, J., & Griliches, Z. (1994). "Changes in the demand for skilled labor within US manufacturing." *Quarterly Journal of Economics*, 109(2), 367-397.
	- Bound, J., & Johnson, G. (1992). "Changes in the structure of wages in the 1980's." *American Economic Review*, 82(3), 371.
	...
	- DiNardo, J. E., & Pischke, J. S. (1997). "The returns to computer use revisited." *Quarterly Journal of Economics*, 112(1), 291-303.
	- Firpo, S., Fortin, N. M., & Lemieux, T. (2011). "Occupational Tasks and Changes in the Wage Structure."
...
4. **Unemployment**
	...
	- Dube, A., Jacobs, J., Naidu, S., & Suri, S. (2018). "Monopsony in Online Labor Markets" (No. w24416). NBER.
	...
	- Krueger, A. B., & Mueller, A. I. (2016). "A contribution to the empirics of reservation wages." *American Economic Journal: Economic Policy*, 8(1), 142-79.
	- Haltiwanger, J., Hyatt, H., Kahn, L. B., & McEntarfer, E. (2017). "Cyclical job ladders by firm size and firm wage" (No. w23485). NBER.
	...
	- Hyatt, H. R., & Spletzer, J. R. (2013). "The recent decline in employment dynamics." *IZA Journal of Labor Economics*, 2(1), 5.
	- McCall, J. J. (1970). "Economics of information and job search." *Quarterly Journal of Economics*, 113-126.
	- Meyer, B. D. (1996). "What have we learned from the Illinois reemployment bonus experiment?" *Journal of Labor Economics*, 26-51.
	...
	- Moscarini, G., & Postel-Vinay, F. (2013). "Stochastic search equilibrium." *Review of Economic Studies*, 80(4), 1545-1581.
	- Moscarini, G., & Postel-Vinay, F. (2016). "Did the job ladder fail after the Great Recession?" *Journal of Labor Economics*, 34(S1), S55-S93.
	- Nekoei, A., & Weber, A. (2017). "Does Extending Unemployment Benefits Improve Job Quality?" *American Economic Review*, 107(2), 527-61.
	- Postel-Vinay, F., & Robin, J. M. (2002). "The distribution of earnings in an equilibrium search model with state-dependent offers and counteroffers." *International Economic Review*, 43(4), 989-1016.
	...
	- Robins, P. K., & Spiegelman, R. G. (2001). *Reemployment Bonuses in the Unemployment Insurance System: Evidence from Three Field Experiments*. WE Upjohn Institute.
	- Schmieder, J. F., von Wachter, T., & Bender, S. (2016). "The effect of unemployment benefits and nonemployment durations on wages." *American Economic Review*, 106(3), 739-77.
	- Bender, S., J. Schmieder, and T. von Wachter (2012). "The Effects of Extended Unemployment Insurance Over the Business Cycle: Regression Discontinuity Estimates over 20 years." *Quarterly Journal of Economics*, pp. 701-752.
	- Chodorow-Reich, G., J. Coglianese, and L. Karabarbounis (2018). "The Limited Macroeconomic Effects of Unemployment Benefit Extensions." *Quarterly Journal of Economics*.
	- Davis, Steven J., and Till M. Von Wachter (2011). "Recessions and the cost of job loss." No. w17638. NBER.
	- Lachowska, Marta, Alexandre Mas, and Stephen A. Woodbury (2018). "Sources of displaced workers' long-term earnings losses." No. w24217. NBER.
	- Jacobson, Louis S., Robert J. LaLonde, and Daniel G. Sullivan (1993). "Earnings losses of displaced workers." *American Economic Review*, 685-709.
	- Johnston, A. and A. Mas (2018). "Potential Unemployment Insurance Duration and Labor Supply: The Individual and Market-Level Response to a Benefit Cut." *Journal of Political Economy*.
	- Kroft, K., F. Lange and M. Notowidigdo (2013). "Duration Dependence and Labor Market Conditions: Evidence from a Field Experiment." *Quarterly Journal of Economics*, 128(3), pp. 1123-1167.
...
5. **Minimum Wage**
	...
	- Cengiz, Doruk, et al. "The effect of minimum wages on low-wage jobs: Evidence from the United States using a bunching estimator." *Quarterly Journal of Economics*.
	- Harasztosi, Péter, and Attila Lindner (2018). "Who Pays for the Minimum Wage?" *American Economic Review*.
	- Lee, D. S. (1999). "Wage inequality in the United States during the 1980s: Rising dispersion or falling minimum wage?" *Quarterly Journal of Economics*, 114(3), 977-1023.
...
9. **Monopsony, Firms and Inequality**
	- Azar, J., Marinescu, I., & Steinbaum, M. I. (2017). "Labor Market Concentration" (No. w24147). NBER.
	- Abowd, J. M., Creecy, R. H., & Kramarz, F. (2002). "Computing person and firm effects using linked longitudinal employer-employee data" (No. 2002-06). US Census Bureau.
	- Abowd, J. M., Kramarz, F., & Margolis, D. N. (1999). "High wage workers and high wage firms." *Econometrica*, 67(2), 251-333.
	- Abowd, J. M., Lengermann, P. A., & McKinney, K. L. (2003). "The Measurement of Human Capital in the US Economy" (No. 2002-09). US Census Bureau.
	...
	- Boeri, T., Ichino, A., Moretti, E., & Posch, J. (2019). "Wage equalization and regional misallocation: evidence from Italian and German provinces."
	...
	- Dauth, W., Findeisen, S., Moretti, E., & Suedekum, J. (2018). "Matching in cities" (No. w25227). NBER.
	...
	- Dube, A., Jacobs, J., Naidu, S., & Suri, S. (2018). "Monopsony in Online Labor Markets." *AER: Insights*.
	- Dustmann, C., Ludsteck, J., & Schönberg, U. (2009). "Revisiting the German Wage Structure." *Quarterly Journal of Economics*, 124(2), 843-881.
	- Fredriksson, P., Hensvik, L., & Nordstrom Skans, O. (2015). "Mismatch of talent: evidence on match quality, entry wages, and job mobility." IZA Working Paper.
	- Garin, A., & Silverio, F. (2019). "How Does Firm Performance Affect Wages? Evidence from Idiosyncratic Export Shocks."
	- Goldschmidt, D., & Schmieder, J. F. (2017). "The rise of domestic outsourcing and the evolution of the German wage structure." *Quarterly Journal of Economics*, 132(3), 1165-1217.
	- Gibbons, R., & Katz, L. (1992). "Does unmeasured ability explain inter-industry wage differentials?" *Review of Economic Studies*, 59(3), 515-535.
	- Huneeus, C., Neilson, C., Miller, C., & Zimmerman, S. (2019). "Firm Matching and the Returns to Elite College Education." Working paper.
	- Lamadon, Thibaut, Magne Mogstad, and Bradley Setzler (2019). "Imperfect Competition, Compensating Differentials and Rent Sharing in the US Labor Market." No. w25954. NBER.
	- Kline, P., Petkova, N., Williams, H., & Zidar, O. (2019). "Who Profits from Patents? Rent-Sharing at Innovative Firms." *Quarterly Journal of Economics*.
	- Krueger, A. B., & Summers, L. H. (1988). "Efficiency wages and the inter-industry wage structure." *Econometrica*, 259-293.
	- Marinescu, Ioana and Hovenkamp, Herbert (2018). "Anticompetitive Mergers in Labor Markets." U of Penn, Inst for Law & Econ Research Paper No. 18-8.
	- Rinz, Kevin (2018). "Labor market concentration, earnings inequality, and earnings mobility." CARRA Working Paper 10.
	- Rose, N. L. (1987). "Labor rent sharing and regulation: Evidence from the trucking industry." *Journal of Political Economy*, 95(6), 1146-1178.
	- Song, J., Price, D. J., Guvenen, F., Bloom, N., & Von Wachter, T. (2018). "Firming up inequality." *Quarterly Journal of Economics*, 134(1), 1-50.
	- Sorkin, Isaac (2018). "Ranking firms using revealed preference." *Quarterly Journal of Economics*, 133(3), 1331-1393.
	- Slichter, S. H. (1950). "Notes on the Structure of Wages." *Review of Economics and Statistics*, 80-91.
